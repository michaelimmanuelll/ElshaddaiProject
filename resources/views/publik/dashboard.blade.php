...
<body>
    ...
    <!-- Navigation -->
    <nav id="navbar">
        <a href="#" class="logo">GPdI EL-SHADDAI</a>
    ...
    <section class="hero">
        ...
        <div class="hero-content">
            <div class="hero-description">GEREJA PANTEKOSTA di INDONESIA</div>
            <h1 class="hero-title">El-Shaddai</h1>
            <p class="hero-description">
                KITA ADALAH GPdI EL-SHADDAI.<br>
                GPdI EL-SHADDAI ADALAH RUMAH KITA
            </p>
    ...
    <section class="activities" id="kegiatan">
        ...
        <div class="activities-grid">
            ...
            <div class="activity-card">
                ...
                <p>
                   -KETERANGAN MKASIH BELUM TAHU-
                </p>
            </div>

            <div class="activity-card">
                <div class="activity-icon">🙏</div>
                <h4>DOA PUASA BAGI PELWAP DAN PELPRIP</h4>
                <div class="activity-time">SELASA, 15:00 WITA</div>
                <p>
                    -KETERANGAN MASIH BELUM TAHU-
                </p>
            </div>
            ...
            <div class="activity-card">
                <div class="activity-icon">👨‍👩‍👧‍👦</div>
                <h4>IBADAH SEKTOR SION</h4>
                <div class="activity-time">Selasa, 19:00 WITA</div>
                <p>
                    -KETERANGAN MASIH BELUM TAHU-
                </p>
            </div>
            ...
            <div class="activity-card">
                <div class="activity-icon">👩</div>
                <h4>IBADAH PELWAP</h4>
                <div class="activity-time">RABU, 17:00 WITA</div>
                <p>
                    -KETERANGAN MASIH BELUM TAHU-
                </p>
            </div>
            ...
            <div class="activity-card">
                <div class="activity-icon">🛐&🎸</div>
                <h4>DOA BANI ASAF & KLINIK MUSIK</h4>
                <div class="activity-time">Rabu, 18:30 WITA</div>
                <p>
                    -KETERANGAN MASIH BELUM TAHU-
                </p>
            </div>
            ...
            <div class="activity-card">
                <div class="activity-icon">👨‍👩‍👧‍👦</div>
                <h4>IBADAH SEKTOR HERMON</h4>
                <div class="activity-time">KAMIS, 19:00 WITA</div>
                <p>
                    -KETERANGAN MASIH BELUM TAHU-
                </p>
            </div>
            ...
            <div class="activity-card">
                <div class="activity-icon">🙏</div>
                <h4>DOA DAN PUASA UMUM</h4>
                <div class="activity-time">JUMAT, 15:00 WITA</div>
                <p>
                    -KETERANGAN MASIH BELUM TAHU-
                </p>
            </div>
            ...
            <div class="activity-card">
                <div class="activity-icon">🙏</div>
                <h4>IBADAH PELPRIP</h4>
                <div class="activity-time">JUMAT, 19:00 WITA</div>
                <p>
                    -KETERANGAN MASIH BELUM TAHU-
                </p>
            </div>
            ...
            <div class="activity-card">
                <div class="activity-icon">🙏</div>
                <h4>LATIHAN MUSIK di GEREJA</h4>
                <div class="activity-time">JUMAT, 18:00 - 21:00 WITA</div>
                <p>
                    -KETERANGAN MASIH BELUM TAHU-
                </p>
            </div>
            ...
            <div class="activity-card">
                <div class="activity-icon">🙏</div>
                <h4>IBADAH REMAJA</h4>
                <div class="activity-time">SABTU, 16:30 WITA</div>
                <p>
            ...
            <div class="activity-card">
                <div class="activity-icon">🙏</div>
                <h4>IBADAH PEMUDA</h4>
                <div class="activity-time">SABTU, 18:30 WITA</div>
                <p>
